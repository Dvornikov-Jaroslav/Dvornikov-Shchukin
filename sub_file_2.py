...
for i in range(1):
    fire_enemy = Enemy(load_image('fire_enemy.png'), 4, 1, level_1[0][0], level_1[0][1])
...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if event.button == 1:
                fire_tower = Tower(load_image('fire_enemy.png'), 4, 1, x * 48, y * 48)
                towers_group.add(fire_tower)
